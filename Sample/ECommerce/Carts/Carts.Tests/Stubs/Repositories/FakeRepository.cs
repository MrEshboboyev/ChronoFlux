...
public class FakeRepository<T>(params (Guid, T)[] aggregates) : IMartenRepository<T> 
    where T : class, IAggregate
{
    public Dictionary<Guid, T> Aggregates { get; } = aggregates.ToDictionary(ks => ks.Item1, vs => vs.Item2);

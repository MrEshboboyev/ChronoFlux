...
using Marten;
using Orders.Orders.GettingPendingOrders;
...
{
    public Task HandleAsync(CancelOrder command, CancellationToken ct) =>
    ...
    public async Task HandleAsync(MinuteHasPassed @event, CancellationToken ct)
    {
